...
const Endpoints = exports.Endpoints = {
  ...
  CDN(root) {
    return {
      ...
      Icon: (guildID, hash) => `${root}/icons/${guildID}/${hash}.${hash.startsWith('a_') ? 'gif' : 'jpg'}`,
      ...
      Splash: (guildID, hash) => `${root}/splashes/${guildID}/${hash}.jpg?size=512`,
...
/**
 * An array of features for guilds.
 */
exports.features = [
  'ANIMATED_ICON',
  'BANNER',
...
/**
 * The type of relations, e.g. `FRIEND`. Here are the available types:
 * * FRIEND
 * * BLOCK
 * * INCOMING
 * * OUTGOING
