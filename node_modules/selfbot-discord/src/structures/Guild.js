...
class Guild {
  ...
  setup(data) {
     ...
     * @type {number}
     */
    this.systemChannelFlagsBitfield = data.system_channel_flags;
  ...
  edit(data, reason) {
    ...
    if (data.features && Array.isArray(data.features)) {
      const gg = data.features.find(feature => !Constants.features.includes(feature));
      if (typeof gg === 'undefined') _data.features = data.features;
      else throw new TypeError(`Feature '${gg}' not found.`);
	}
    ...
    if (typeof data.systemChannelFlags !== 'undefined') {
      _data.system_channel_flags = data.systemChannelFlags;
    }
