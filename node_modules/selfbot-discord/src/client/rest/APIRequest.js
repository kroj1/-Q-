...
class APIRequest {
  ...
  getAuth() {
    if (this.client.token && this.client.user && this.client.user.bot) {
      throw new Error(Constants.Errors.NO_USER_ACCOUNT);
  ...
  gen() {
    ...
    if (!this.rest.client.browser) request.set('User-Agent', "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.9001 Chrome/83.0.4103.122 Electron/9.3.5 Safari/537.36");
    if (this.files) {
